...
[AWS LangChain S3 Vector TypeScript](../README.md) / S3VectorsListOptions

# Interface: S3VectorsListOptions
...
Defined in: [types.ts:447](https://github.com/FarukAda/aws-langchain-s3-vector-ts/blob/main/src/types.ts#L447)
